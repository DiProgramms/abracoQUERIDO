...
<html>
    ...
    <body>
            ...
            <div class="container">
                ...
                <div class=" collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav ml-auto">
                        <li class="nav-item">
                            <a class="nav-link" href="./menuprincipalESTAGIARO.php">Voltar</a>
                        </li>
        ...
        <main>
            ...
            <form class="px-4 py-3" action="../modulos_php/atualiza_dados" method="POST">
                <div class="form-row">
                    <div class="form-group col-md-6">
                        <label for="username">Usuário:</label>
                        <input type="text" class="form-control" id="username" name="username" value="<?php echo $username;?>" required disabled>
                    </div>
                    <div class="form-group col-md-6">
