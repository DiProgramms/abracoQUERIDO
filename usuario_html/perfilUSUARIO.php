...
<html>
    ...
    <body>
            ...
            <div class="container">
                ...
                <div class=" collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav ml-auto">
                        <li class="nav-item">
                            <a class="nav-link" href="./menuprincipalUSUARIO.php">Voltar</a>
                        </li>
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                                <a class="dropdown-item" href="#">Lista de Amigos</a>
        ...
        <main>
            <?php include ('../modulos_php/carrega_dados.php')?>

            <h1 class="TituloPD">Perfil do Usuário</h1>
                <div class="text-center d-flex justify-content-center align-items-center">
                    <img src="../img/avatar-padrao.jpg" class="avatar-padrao">
                </div>
            <div class="text-center d-flex justify-content-center align-items-center">
            ...
            <div class="box-Perfil text-center d-flex justify-content-center align-items-center">
            <form class="px-4 py-3" action="../modulos_php/atualiza_dados.php" method="POST">
                <div class="form-row">
                    <div class="form-group col-md-6">
                        <label for="username">Usuário:</label>
                        <input type="text" class="form-control" id="username" name="username" value="<?php echo $username;?>"disabled required>
                        <input type="hidden" name="original_username" value="<?php echo $username; ?>">
                    </div>
                    <div class="form-group col-md-6">
                        <label for="password">Senha:</label>
                        <input type="password" class="form-control" id="password" name="password" value="<?php echo $senha;?>"required>
                    </div>
                </div>
                <hr>
                <div class="form-row">
                ...
                <hr>
                <div class="form-group">
                    <label for="row">Tipo de Conta:</label>
                    <input type="text" class="form-control" id="row" name="row" value="<?php echo $tipoESCRITO;?>" disabled >
                </div>
